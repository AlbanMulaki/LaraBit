...
return [
    ...
    'messages' => [
        'common::validation' => [
            'permission_denied', 'generic_error', 'select_option','successfully','duplicate_entry'
        ],
        'system::validation' => ['health_check_attached'],
        'passwords' => [
            'password', 'user', 'token'
        ],
        'users::validation' => [
            'success_attach_permission', 'success_attach_permission_desc', 'success_revoked_permission', 'success_revoked_permission_desc'
        ],
        'login' => [
            'username',
            'password',
