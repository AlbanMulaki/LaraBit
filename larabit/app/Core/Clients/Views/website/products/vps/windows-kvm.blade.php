    ...
    <div class="row">
        <div class="col-lg-8 col-md-8 col-sm-8 col-xs-12">
            ...
            <p>
                ...
                offers great versatility allowing you to install <strong>Windows Server 2012</strong> or <strong>Windows 8.1</strong> operating systems.
...
<div class="feature-solutions-small">
    <div class="container" >
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            <h2>Windows VPS Server</h2>
            <p>
                Windows VPS Servers Packages are fully-managed by our experts.
            </p>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 feature-solutions-small-single">
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <p>
                        Each virtual server offers great versatility allowing you to install Windows Server 2012 or Windows 8.1 operating systems.
                    </p>
                </div>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
...
<div class="container ">
    <div class="col-xs-12  text-center" style="margin:20px 0;">
        <h2>Windows VPS Server Pricing</h2>
        <p>Windows VPS Server High Performance SSD Hosting has competitive pricing.</p>
    </div>
    <div class="col-xs-12 text-center" style="margin:20px 0;">
        <a href="#price-table" class="btn btn-lg btn-primary"><i class="fa fa-arrow-circle-right"></i> &nbsp;View Price VPS </a>
    </div>
</div>
...
<div class="feature-solutions-small" id="price-table">
    <div class="container" >
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 text-center">
            <h2>Windows VPS Server Order</h2>
            <h4>
                Windows VPS Server High Performance SSD solutions!
            </h4>
            <p>Windows VPS Server High Performance SSD Hosting has competitive pricing.</p>
            <h3> Starting from €14.95</h3>
        </div>
        <div class="col-xs-12 text-center">
           
            <a class="btn btn-lg btn-warning">Customize your VPS <i class='fa fa-arrow-circle-right'></i></a>
            <br><br>
            <br><br>
        </div>
    </div>
